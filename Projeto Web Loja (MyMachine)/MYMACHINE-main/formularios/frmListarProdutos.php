...
<body>
    ...
    <div class="table-responsive-xl col-md-12 mt-5">
        <h3>PRODUTOS
            <a class="produtos">
                <a class="btn-floating btn-large waves-effect waves-light green" onclick="JavaScript:location.href='../formularios/frmInsProdutos.php'"><i class="material-icons">add</i></a>
            </a>
        </h3>
        <table class="table border border-secondary">
            ...
            ?>
                <tr>
                    ...
                    <td class="align-middle"><a class="btn-floating btn-small waves-effect waves-light black" onclick="JavaScript:location.href='../formularios/frmEdtProdutos.php?ID=' + 
                           <?php echo $produto['ID']; ?>">
                            <i class="material-icons">edit</i></a></td>

                    <td class="align-middle"><a class="btn-floating btn-small waves-effect waves-light black" onclick="JavaScript:location.href='../formularios/frmRemProdutos.php?ID=' + 
                           <?php echo $produto['ID']; ?>">

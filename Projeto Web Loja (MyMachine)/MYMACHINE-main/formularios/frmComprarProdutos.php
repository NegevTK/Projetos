...
<body>
    <div class="table-responsive-xl col-md-6 m-5">
        <div class="border border-secondary">
            ...
            <form action="../metodos/compProdutos.php" method="GET" id="frmComprarProdutos" name="frmCompraProdutos" class="col s12">
                ...
                <div class="form-group">
                    ...
                    <button class="btn btn-primary btn btn-dark" type="button" name="btnVoltar" onclick="JavaScript:location.href='../formularios/index.php'">Voltar
